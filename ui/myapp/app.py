...
def create_app(test_config: dict | None = None) -> Flask:
    ...
    app.config.from_mapping(
        ...
        CONSUMER_IMAGE_URL=os.environ.get("CONSUMER_IMAGE_URL", ""), CONSUMER_CONTAINER_NAME_PREFIX=os.environ.get("CONSUMER_CONTAINER_NAME_PREFIX", "object-storage-stream-processor"),
