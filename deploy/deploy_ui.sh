...
if [[ "$OCI_CONTAINER_ORCHESTRATION_ENABLED" == "true" ]]; then
  for value in SUBNET_ID CONTAINER_AVAILABILITY_DOMAIN CONSUMER_SHAPE CONSUMER_OCPUS CONSUMER_MEMORY_GBS CONSUMER_IMAGE_URL DB_SECRET_OCID DB_HOST DB_PORT DB_USER DB_NAME STREAM_DATA_DB_NAME; do
