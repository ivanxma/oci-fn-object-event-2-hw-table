...
ExecStart=/usr/bin/podman run --rm --name $UI_CONTAINER_NAME --network host --env-file $RUNTIME_ENV -v $INSTANCE_DIR:/app/instance:Z,U $UI_IMAGE python -m flask --app myapp.app run --host 127.0.0.1 --port $UI_BIND_PORT
